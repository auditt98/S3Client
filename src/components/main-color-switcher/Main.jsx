	...
	return (
		<>
			...
			<div className='shadow-md fixed bottom-0 right-0 box border rounded-full h-12 px-5 flex items-center justify-center z-50 mb-10 mr-52'>
				<div className='mr-4 hidden sm:block text-slate-600 dark:text-slate-200'>Color Scheme</div>
				<a
					onClick={() => {
						switchColorScheme('default');
					}}
					className={classnames({
						'block w-8 h-8 cursor-pointer bg-primary rounded-full border-4 mr-1 hover:border-slate-200': true,
