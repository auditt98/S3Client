...
export default function UsersUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...usersRecord };
    setAccessKeyId(cleanValues.accessKeyId);
    setSecretAccessKey(cleanValues.secretAccessKey);
    setErrors({});
  };
  const [usersRecord, setUsersRecord] = React.useState(users);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Users, id) : users;
