...
export declare type UsersCreateFormValidationValues = {
    accessKeyId?: ValidationFunction<string>;
    secretAccessKey?: ValidationFunction<string>;
};
export declare type FormProps<T> = Partial<T> & React.DOMAttributes<HTMLDivElement>;
export declare type UsersCreateFormOverridesProps = {
    UsersCreateFormGrid?: FormProps<GridProps>;
    accessKeyId?: FormProps<TextFieldProps>;
    secretAccessKey?: FormProps<TextFieldProps>;
} & EscapeHatchProps;
