...
const fakers = {
	...
	fakePhotos() {
		const photos = [];
		for (let i = 0; i < 15; i++) {
			photos[photos.length] = imageAssets['/src/assets/images/profile-' + _.random(1, 15) + '.jpg'].default;
		}
	...
	fakeImages() {
		const images = [];
		for (let i = 0; i < 15; i++) {
			images[images.length] = imageAssets['/src/assets/images/preview-' + _.random(1, 15) + '.jpg'].default;
		}
