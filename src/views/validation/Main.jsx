...
import { Lucide, PreviewComponent, Preview, Source, Highlight } from '@/base-components';
	...
	const schema = yup
		.object({
			...
			age: yup
				.number()
				.required()
				.test('len', 'age must be less than or equal to 3', (val) => val.toString().length <= 3),
			url: yup.string().url(),
						...
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Implementation</h2>
									...
									<Preview>
										...
										<form className='validate-form' onSubmit={onSubmit}>
											...
											<div className='input-form mt-3'>
												...
												/>
												{errors.age && (
													<div className='text-danger mt-2'>{errors.age.message}</div>
												)}
											</div>
											<div className='input-form mt-3'>
												<label
												...
												/>
												{errors.url && (
													<div className='text-danger mt-2'>{errors.url.message}</div>
												)}
											</div>
											<div className='input-form mt-3'>
												<label
												...
												></textarea>
												{errors.comment && (
													<div className='text-danger mt-2'>{errors.comment.message}</div>
												)}
											</div>
