						...
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Basic Notification</h2>
								...
								<div className='p-5'>
									<Preview>
										<div className='text-center'>
											...
											>
												<div className='font-medium'>Yay! Updates Published!</div>
												<a
                ...
                `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Success Notification</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div className='p-5'>
									<Preview>
										<div className='text-center'>
											...
											{/* BEGIN: Notification Toggle */}
											<button className='btn btn-primary' onClick={successNotificationToggle}>
												Show Notification
											</button>
											{/* END: Notification Toggle */}
										</div>
                ...
                `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Notification With Actions</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div className='p-5'>
									<Preview>
										<div className='text-center'>
											...
											>
												...
												<div className='ml-4 mr-4'>
													...
													<div className='font-medium flex mt-1.5'>
														<a className='text-primary dark:text-slate-400' href=''>
															Restart Now
														</a>
											...
											{/* END: Notification Content */}
											{/* BEGIN: Notification Toggle */}
											<button className='btn btn-primary' onClick={notificationWithActionsToggle}>
												Show Notification
											</button>
											{/* END: Notification Toggle */}
										</div>
				...
				<div className='intro-y col-span-12 lg:col-span-6'>
					...
					<PreviewComponent className='intro-y box'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Notification With Avatar</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
										...
										<div className='text-center'>
											...
											>
												...
												<div className='ml-4 sm:mr-28'>
													...
													<div className='text-slate-500 mt-1'>See you later! 😃😃😃</div>
												</div>
												<a
											...
											{/* END: Notification Content */}
											{/* BEGIN: Notification Toggle */}
											<button className='btn btn-primary' onClick={notificationWithAvatarToggle}>
												Show Notification
											</button>
											{/* END: Notification Toggle */}
										</div>
                ...
                `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Notification With Split Buttons</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
										...
										<div className='text-center'>
											...
											>
												<div className='sm:mr-40'>
													<div className='font-medium'>Introducing new theme</div>
													<div className='text-slate-500 mt-1'>Release version 2.3.3</div>
												</div>
                ...
                `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Notification With Buttons Below</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
										...
										<div className='text-center'>
											...
											>
												...
												<div className='ml-4 mr-5 sm:mr-20'>
													<div className='font-medium'>{$f()[0].users[0].name}</div>
													<div className='text-slate-500 mt-1'>Sent you new documents.</div>
													<div className='mt-2.5'>
														<a className='btn btn-primary py-1 px-2 mr-2' href=''>
															Preview
														</a>
														<a className='btn btn-outline-secondary py-1 px-2' href=''>
															Download
														</a>
													</div>
												</div>
