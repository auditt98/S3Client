				...
				},
				{
                  ...
                  <div class="intro-x w-10 h-10 image-fit">
                    <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="${
						imageAssets['/src/assets/images/' + cell.getData().images[0]].default
					}">
                  </div>
                  <div class="intro-x w-10 h-10 image-fit -ml-5">
                    <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="${
						imageAssets['/src/assets/images/' + cell.getData().images[1]].default
					}">
                  </div>
                  <div class="intro-x w-10 h-10 image-fit -ml-5">
                    <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="${
						imageAssets['/src/assets/images/' + cell.getData().images[2]].default
					}">
                  </div>
              </div>`;
					},
		...
		<>
			...
			<div className='intro-y box p-5 mt-5'>
							...
							<DropdownMenu className='w-40'>
								<DropdownContent>
									...
									<DropdownItem onClick={onExportJson}>
										<Lucide icon='FileText' className='w-4 h-4 mr-2' /> Export JSON
									</DropdownItem>
									<DropdownItem onClick={onExportXlsx}>
										<Lucide icon='FileText' className='w-4 h-4 mr-2' /> Export XLSX
									</DropdownItem>
									<DropdownItem onClick={onExportHtml}>
										<Lucide icon='FileText' className='w-4 h-4 mr-2' /> Export HTML
									</DropdownItem>
								</DropdownContent>
							</DropdownMenu>
						</Dropdown>
				...
				<div className='overflow-x-auto scrollbar-hidden'>
					<div id='tabulator' ref={tableRef} className='mt-5 table-report table-report--tabulator'></div>
				</div>
			</div>
			{/* END: HTML Table Data */}
		</>
