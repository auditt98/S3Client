import { Lucide, LoadingIcon, PreviewComponent, Preview, Source, Highlight } from '@/base-components';
						...
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Basic Buttons</h2>
								...
								<div className='p-5'>
									<Preview>
										...
										<button className='btn btn-secondary w-24 mr-1 mb-2'>Secondary</button>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Button Sizes</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div className='p-5'>
									<Preview>
										<div>
											<button className='btn btn-sm btn-primary w-24 mr-1 mb-2'>Small</button>
											<button className='btn btn-primary w-24 mr-1 mb-2'>Medium</button>
											<button className='btn btn-lg btn-primary w-24 mr-1 mb-2'>Large</button>
										</div>
										<div className='mt-5'>
											<button className='btn btn-sm btn-secondary w-24 mr-1 mb-2'>Small</button>
											<button className='btn btn-secondary w-24 mr-1 mb-2'>Medium</button>
											<button className='btn btn-lg btn-secondary w-24 mr-1 mb-2'>Large</button>
										</div>
									</Preview>
									<Source>
										<Highlight>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Working with Links</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Elevated Buttons</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div className='p-5'>
									<Preview>
										<div>
											<button className='btn btn-elevated-primary w-24 mr-1 mb-2'>Primary</button>
											<button className='btn btn-elevated-secondary w-24 mr-1 mb-2'>
												Secondary
											</button>
											<button className='btn btn-elevated-success w-24 mr-1 mb-2'>Success</button>
											<button className='btn btn-elevated-warning w-24 mr-1 mb-2'>Warning</button>
											<button className='btn btn-elevated-pending w-24 mr-1 mb-2'>Pending</button>
											<button className='btn btn-elevated-danger w-24 mr-1 mb-2'>Danger</button>
											<button className='btn btn-elevated-dark w-24 mr-1 mb-2'>Dark</button>
										</div>
										<div className='mt-5'>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Social Media Buttons</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
				...
				<div className='col-span-12 lg:col-span-6'>
					...
					<PreviewComponent className='intro-y box'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Outline Buttons</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Loading State Buttons</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div className='p-5'>
									<Preview>
										...
										<button className='btn btn-warning mr-1 mb-2'>
											Loading
											<LoadingIcon icon='three-dots' color='1a202c' className='w-4 h-4 ml-2' />
										</button>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Rounded Buttons</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
										<label className='form-check-label ml-0' htmlFor='show-example-8'>
											Show example code
										</label>
										<input
											onClick={toggle}
								...
								<div className='p-5'>
									<Preview>
										<button className='btn btn-rounded-primary w-24 mr-1 mb-2'>Primary</button>
										<button className='btn btn-rounded-secondary w-24 mr-1 mb-2'>Secondary</button>
										<button className='btn btn-rounded-success w-24 mr-1 mb-2'>Success</button>
										<button className='btn btn-rounded-warning w-24 mr-1 mb-2'>Warning</button>
										<button className='btn btn-rounded-pending w-24 mr-1 mb-2'>Pending</button>
										<button className='btn btn-rounded-danger w-24 mr-1 mb-2'>Danger</button>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Soft Color Buttons</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
										<label className='form-check-label ml-0' htmlFor='show-example-9'>
											Show example code
										</label>
										<input
											onClick={toggle}
								...
								<div className='p-5'>
									<Preview>
										...
										<button className='btn btn-rounded btn-dark-soft w-24 mr-1 mb-2'>Dark</button>
									</Preview>
									<Source>
										<Highlight>
											{`
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Icon Buttons</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
										<label className='form-check-label ml-0' htmlFor='show-example-10'>
											Show example code
										</label>
										<input
											onClick={toggle}
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Icon Only Buttons</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
										<label className='form-check-label ml-0' htmlFor='show-example-11'>
											Show example code
										</label>
										<input
											onClick={toggle}
