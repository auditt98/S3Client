		...
		<>
			<div className='intro-y flex flex-col sm:flex-row items-center mt-8'>
				...
				<div className='w-full sm:w-auto flex mt-4 sm:mt-0'>
					...
					<button type='button' className='btn box mr-2 flex items-center ml-auto sm:ml-0'>
					...
					<Dropdown>
						...
						<DropdownMenu className='w-40'>
							<DropdownContent>
								...
								<DropdownItem>
									<Lucide icon='FileText' className='w-4 h-4 mr-2' /> Export to Word
								</DropdownItem>
							</DropdownContent>
						</DropdownMenu>
					</Dropdown>
			...
			<div className='pos intro-y grid grid-cols-12 gap-5 mt-5'>
				...
				<div className='intro-y col-span-12 lg:col-span-8'>
					<input type='text' className='intro-y form-control py-3 px-4 box pr-10' placeholder='Title' />
							...
							<TabPanel className='p-5'>
								<div className='border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5'>
									<div className='font-medium flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5'>
										<Lucide icon='ChevronDown' className='w-4 h-4 mr-2' /> Text Content
									</div>
									<div className='mt-5'>
										...
										<div className='mt-3'>
											...
											<div className='border-2 border-dashed dark:border-darkmode-400 rounded-md pt-4'>
												...
												<div className='px-4 pb-4 flex items-center cursor-pointer relative'>
													...
													<span className='text-primary mr-1'>Upload a file</span> or drag and
													drop
													<input
														type='file'
				...
				<div className='col-span-12 lg:col-span-4'>
					<div className='intro-y box p-5'>
						...
						<div className='mt-3'>
							...
							<TomSelect id='post-form-4' value={tags} onChange={setTags} className='w-full' multiple>
						...
						<div className='form-check form-switch flex flex-col items-start mt-3'>
							<label htmlFor='post-form-5' className='form-check-label ml-0 mb-2'>
								Published
							</label>
							<input id='post-form-5' className='form-check-input' type='checkbox' />
						</div>
						<div className='form-check form-switch flex flex-col items-start mt-3'>
							<label htmlFor='post-form-6' className='form-check-label ml-0 mb-2'>
								Show Author Name
							</label>
