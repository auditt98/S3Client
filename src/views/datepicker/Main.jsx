						...
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Basic Date Picker</h2>
				...
				<div className='col-span-12 lg:col-span-6'>
					...
					<PreviewComponent className='intro-y box'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Date Range Picker</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Modal Date Picker</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div className='p-5'>
									<Preview>
										...
										>
											{/* BEGIN: Modal Header */}
											<ModalHeader>
												<h2 className='font-medium text-base mr-auto'>Filter by Date</h2>
											...
											<ModalBody className='grid grid-cols-12 gap-4 gap-y-3'>
												...
												<div className='col-span-12 sm:col-span-6'>
													<label htmlFor='modal-datepicker-2' className='form-label'>
														To
													</label>
													<Litepicker
