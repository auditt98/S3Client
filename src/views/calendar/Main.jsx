		...
		<>
			<div className='intro-y flex flex-col sm:flex-row items-center mt-8'>
				...
				<div className='w-full sm:w-auto flex mt-4 sm:mt-0'>
					<button className='btn btn-primary shadow-md mr-2'>Print Schedule</button>
						...
						>
								...
								<div className='event p-3 -mx-3 cursor-pointer transition duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md flex items-center'>
									...
									<div className='pr-10'>
										...
										<div className='text-slate-500 text-xs mt-0.5'>
											<span className='event__days'>2</span> Days <span className='mx-1'>•</span>{' '}
											10:00 AM
										</div>
									</div>
								</div>
								<a className='flex items-center absolute top-0 bottom-0 my-auto right-0' href=''>
							...
							<div className='relative'>
								<div className='event p-3 -mx-3 cursor-pointer transition duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md flex items-center'>
									...
									<div className='pr-10'>
										<div className='event__title truncate'>Vue Fes Japan 2019</div>
										<div className='text-slate-500 text-xs mt-0.5'>
											<span className='event__days'>3</span> Days <span className='mx-1'>•</span>{' '}
											07:00 AM
										</div>
									</div>
								</div>
							...
							<div className='relative'>
								<div className='event p-3 -mx-3 cursor-pointer transition duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md flex items-center'>
									...
									<div className='pr-10'>
										...
										<div className='text-slate-500 text-xs mt-0.5'>
											<span className='event__days'>4</span> Days <span className='mx-1'>•</span>{' '}
											11:00 AM
										</div>
									</div>
								</div>
							...
							<div className='text-slate-500 p-3 text-center hidden' id='calendar-no-events'>
								No events yet
							</div>
						</FullCalendarDraggable>
