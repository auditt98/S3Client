								...
								<div className='p-5'>
									<Preview>
										<div>
											...
											<h2 className='text-3xl font-medium leading-none mt-3'>h2. Heading 2</h2>
											<h3 className='text-2xl font-medium leading-none mt-3'>h3. Heading 3</h3>
											<h4 className='text-xl font-medium leading-none mt-3'>h4. Heading 4</h4>
											<h5 className='text-lg font-medium leading-none mt-3'>h5. Heading 5</h5>
							...
							<>
								...
								<div className='p-5'>
									<Preview>
										...
										<u className='block mt-1'>This line of text will render as underlined</u>
										<small className='block mt-1'>
											This line of text is meant to be treated as fine print.
										</small>
										<strong className='block mt-1'>This line rendered as bold text.</strong>
							...
							<>
								...
								<div className='p-5'>
									<Preview>
										...
										<div className='mt-3'>
											<span className='px-2 py-1 rounded-full bg-primary text-white mr-1'>1</span>
											<span className='px-2 py-1 rounded-full border text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300 mr-1'>
												2
											</span>
											<span className='px-2 py-1 rounded-full bg-success text-white mr-1'>3</span>
											<span className='px-2 py-1 rounded-full bg-warning text-white mr-1'>4</span>
											<span className='px-2 py-1 rounded-full bg-danger text-white mr-1'>5</span>
											<span className='px-2 py-1 rounded-full bg-slate-100 text-slate-500 dark:bg-darkmode-800 dark:text-slate-300 mr-1'>
												6
											</span>
										</div>
										<div className='mt-4'>
											<span className='px-3 py-2 rounded-full bg-primary text-white mr-1'>1</span>
											<span className='px-3 py-2 rounded-full border text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300 mr-1'>
												2
											</span>
											<span className='px-3 py-2 rounded-full bg-success text-white mr-1'>3</span>
											<span className='px-3 py-2 rounded-full bg-warning text-white mr-1'>4</span>
											<span className='px-3 py-2 rounded-full bg-danger text-white mr-1'>5</span>
											<span className='px-3 py-2 rounded-full bg-slate-100 text-slate-500 dark:bg-darkmode-800 dark:text-slate-300 mr-1'>
												6
											</span>
										</div>
										<div className='mt-6'>
											<span className='px-4 py-3 rounded-full bg-primary text-white mr-1'>1</span>
											<span className='px-4 py-3 rounded-full border text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300 mr-1'>
												2
											</span>
											<span className='px-4 py-3 rounded-full bg-success text-white mr-1'>3</span>
											<span className='px-4 py-3 rounded-full bg-warning text-white mr-1'>4</span>
											<span className='px-4 py-3 rounded-full bg-danger text-white mr-1'>5</span>
