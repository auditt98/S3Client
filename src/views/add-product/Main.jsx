			...
			<div className='grid grid-cols-11 gap-x-6 mt-5 pb-20'>
				...
				<div className='intro-y col-span-11 2xl:col-span-9'>
										...
										<div className='text-left'>
											...
											<div className='leading-relaxed text-slate-500 text-xs mt-3'>
												...
												<div className='mt-2'>
													...
													Include min. 3 attractive photos to make the product more attractive
													to buyers.
												</div>
											</div>
										</div>
					...
					<div className='intro-y box p-5 mt-5'>
						<div className='border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5'>
							<div className='font-medium text-base flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5'>
								<Lucide icon='ChevronDown' className='w-4 h-4 mr-2' /> Product Information
							</div>
							<div className='mt-5'>
									...
									<div className='form-label xl:w-64 xl:!mr-10'>
										<div className='text-left'>
											...
											<div className='leading-relaxed text-slate-500 text-xs mt-3'>
												...
												buyers to find, consisting of product type, brand, and information such
								...
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									<div className='form-label xl:w-64 xl:!mr-10'>
										<div className='text-left'>
											...
											<div className='leading-relaxed text-slate-500 text-xs mt-3'>
												You can add a new subcategory or choose from the existing subcategory
												list.
											</div>
										</div>
									</div>
					...
					<div className='intro-y box p-5 mt-5'>
						<div className='border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5'>
							<div className='font-medium text-base flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5'>
								<Lucide icon='ChevronDown' className='w-4 h-4 mr-2' /> Product Detail
							</div>
							<div className='mt-5'>
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									<div className='form-label xl:w-64 xl:!mr-10'>
									...
									<div className='w-full mt-3 xl:mt-0 flex-1'>
										<div className='flex flex-col sm:flex-row'>
											<div className='form-check mr-4'>
												...
												/>
												<label className='form-check-label' htmlFor='condition-new'>
													New
												</label>
											</div>
											<div className='form-check mr-4 mt-2 sm:mt-0'>
												...
												/>
												<label className='form-check-label' htmlFor='condition-second'>
													Second
												</label>
											</div>
										</div>
								...
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									<div className='form-label xl:w-64 xl:!mr-10'>
										<div className='text-left'>
											...
											<div className='leading-relaxed text-slate-500 text-xs mt-3'>
												<div>
													Make sure the product description provides a detailed explanation of
													your product so that it is easy to understand and find your product.
												</div>
												<div className='mt-2'>
													It is recommended not to enter info on mobile numbers, e-mails, etc.
													into the product description to protect your personal data.
												</div>
											</div>
										</div>
									</div>
									<div className='w-full mt-3 xl:mt-0 flex-1'>
										...
										<div className='form-help text-right'>Maximum character 0/2000</div>
									</div>
								</div>
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									<div className='form-label xl:w-64 xl:!mr-10'>
									...
									<div className='w-full mt-3 xl:mt-0 flex-1'>
										<button className='btn btn-outline-secondary w-40'>
											<Lucide icon='Plus' className='w-4 h-4 mr-2' /> Add Video URL
										</button>
									</div>
								</div>
							</div>
					...
					<div className='intro-y box p-5 mt-5'>
						<div className='border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5'>
							<div className='font-medium text-base flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5'>
								<Lucide icon='ChevronDown' className='w-4 h-4 mr-2' /> Product Variant
							</div>
							<div className='mt-5'>
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									<div className='form-label sm:!mr-10'>
										<div className='text-left'>
											...
											<div className='leading-relaxed text-slate-500 text-xs mt-2'>
												Add variants such as color, size, or more. Choose a maximum of 2 variant
												types.
											</div>
										</div>
									</div>
									<div className='w-full mt-3 xl:mt-0 flex-1 xl:text-right'>
										<button className='btn btn-primary w-44'>
											<Lucide icon='Plus' className='w-4 h-4 mr-2' /> Add Variant
										</button>
									</div>
								</div>
							</div>
					...
					<div className='intro-y box p-5 mt-5'>
						<div className='border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5'>
							<div className='font-medium text-base flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5'>
								<Lucide icon='ChevronDown' className='w-4 h-4 mr-2' /> Product Variant (Details)
							</div>
							<div className='mt-5'>
								<div className='form-inline items-start flex-col xl:flex-row mt-2 pt-2 first:mt-0 first:pt-0'>
									...
									<div className='w-full mt-3 xl:mt-0 flex-1'>
										<div className='relative pl-5 pr-5 xl:pr-10 py-10 bg-slate-50 dark:bg-transparent dark:border rounded-md'>
											<a href='' className='text-slate-500 absolute top-0 right-0 mr-4 mt-4'>
											...
											<div>
												...
												<div className='form-inline mt-5 items-start first:mt-0'>
													<label className='form-label mt-2 sm:w-20'>Options</label>
												...
												<div className='xl:ml-20 xl:pl-5 xl:pr-20 mt-5 first:mt-0'>
													<button className='btn btn-outline-primary border-dashed w-full'>
														<Lucide icon='Plus' className='w-4 h-4 mr-2' /> Add New Option
													</button>
												</div>
											</div>
										</div>
								...
								<div className='xl:ml-64 xl:pl-10 mt-2 pt-2 first:mt-0 first:pt-0'>
									<button className='btn py-3 btn-outline-secondary border-dashed w-full'>
										<Lucide icon='Plus' className='w-4 h-4 mr-2' /> Add New Variant
									</button>
								</div>
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									<div className='form-label xl:w-64 xl:!mr-10'>
									...
									<div className='w-full mt-3 xl:mt-0 flex-1'>
										<div className='sm:grid grid-cols-4 gap-2'>
											...
											/>
											<button className='btn btn-primary mt-2 sm:mt-0'>Apply To All</button>
										</div>
									</div>
								</div>
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
												...
												<thead>
													<tr>
														...
														<th className='bg-slate-50 dark:bg-darkmode-800 text-slate-500 whitespace-nowrap'>
															<div className='flex items-center'>
																Color{' '}
																<Lucide icon='HelpCircle' className='w-4 h-4 ml-2' />
															</div>
														</th>
								...
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									...
									<div className='w-full mt-3 xl:mt-0 flex-1'>
											...
											<table className='table border'>
												...
												<tbody>
													<tr>
														...
														<td className='whitespace-nowrap'>Wholesale Price 1</td>
														<td className='!px-2'>
															<input
																type='text'
																className='form-control min-w-[6rem]'
													...
													<tr>
														...
														<td className='whitespace-nowrap'>Wholesale Price 2</td>
														<td className='!px-2'>
															<input
																type='text'
																className='form-control min-w-[6rem]'
													...
													<tr>
														...
														<td className='whitespace-nowrap'>Wholesale Price 3</td>
														<td className='!px-2'>
															<input
																type='text'
																className='form-control min-w-[6rem]'
										...
										<button className='btn btn-outline-primary border-dashed w-full mt-4'>
											<Lucide icon='Plus' className='w-4 h-4 mr-2' /> Add New Wholesale Price
										</button>
									</div>
								</div>
							</div>
					...
					<div className='intro-y box p-5 mt-5'>
						<div className='border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5'>
							<div className='font-medium text-base flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5'>
								<Lucide icon='ChevronDown' className='w-4 h-4 mr-2' /> Product Management
							</div>
							<div className='mt-5'>
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									<div className='form-label xl:w-64 xl:!mr-10'>
										<div className='text-left'>
											...
											<div className='leading-relaxed text-slate-500 text-xs mt-3'>
												If the status is active, your product can be searched for by potential
												buyers.
											</div>
										</div>
									</div>
								...
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									...
									<div className='w-full mt-3 xl:mt-0 flex-1'>
										<input id='sku' type='text' className='form-control' placeholder='Input SKU' />
									</div>
								</div>
							</div>
						</div>
					...
					<div className='intro-y box p-5 mt-5'>
						<div className='border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5'>
							<div className='font-medium text-base flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5'>
								<Lucide icon='ChevronDown' className='w-4 h-4 mr-2' /> Weight & Shipping
							</div>
							<div className='mt-5'>
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									<div className='form-label xl:w-64 xl:!mr-10'>
										...
										<Alert className='alert-outline-warning alert-dismissible bg-warning/20 dark:bg-darkmode-400 dark:border-darkmode-400 mt-5'>
											{({ dismiss }) => (
												<>
													<div className='flex items-center'>
														<span>
															<Lucide icon='AlertTriangle' className='w-6 h-6 mr-3' />
														</span>
								...
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									<div className='form-label xl:w-64 xl:!mr-10'>
										<div className='text-left'>
											...
											<div className='leading-relaxed text-slate-500 text-xs mt-3'>
												Refund product & postage for the seller and buyer in case of damage /
								...
								<div className='form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0'>
									...
									<div className='w-full mt-3 xl:mt-0 flex-1'>
										<div className='form-check form-switch'>
											<input id='preorder-active' className='form-check-input' type='checkbox' />
											<label
					...
					<div className='flex justify-end flex-col md:flex-row gap-2 mt-5'>
						...
						<button type='button' className='btn py-3 btn-primary w-full md:w-52'>
							Save
						</button>
					</div>
				</div>
