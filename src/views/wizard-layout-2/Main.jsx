			...
			<div className='intro-y box py-10 sm:py-20 mt-5'>
				<div className='px-5 sm:px-20'>
					...
					<div className='intro-x flex items-center mt-5'>
						...
						<div className='text-base text-slate-600 dark:text-slate-500 ml-3'>Setup Your Profile</div>
					</div>
					<div className='intro-x flex items-center mt-5'>
						<button className='w-10 h-10 rounded-full btn text-slate-500 bg-slate-100 dark:bg-darkmode-400 dark:border-darkmode-400'>
							3
					...
					<div className='intro-x flex items-center mt-5'>
						...
						<div className='text-base text-slate-600 dark:text-slate-500 ml-3'>Setup Billing Account</div>
					</div>
					<div className='intro-x flex items-center mt-5'>
						<button className='w-10 h-10 rounded-full btn text-slate-500 bg-slate-100 dark:bg-darkmode-400 dark:border-darkmode-400'>
							5
						</button>
						<div className='text-base text-slate-600 dark:text-slate-500 ml-3'>Finalize your purchase</div>
					</div>
				</div>
