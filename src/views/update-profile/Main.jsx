								...
								<div className='flex-1 mt-6 xl:mt-0'>
									<div className='grid grid-cols-12 gap-x-5'>
										...
										<div className='col-span-12 2xl:col-span-6'>
											...
											<div className='mt-3'>
												<label htmlFor='update-profile-form-4' className='form-label'>
													Phone Number
												</label>
												<input
										...
										<div className='col-span-12'>
											<div className='mt-3'>
												<label htmlFor='update-profile-form-5' className='form-label'>
													Address
												</label>
												<textarea
						...
						<div className='p-5'>
							<div className='grid grid-cols-12 gap-x-5'>
								<div className='col-span-12 xl:col-span-6'>
									...
									<div className='mt-3'>
										<label htmlFor='update-profile-form-8' className='form-label'>
											ID Type
										</label>
								...
								<div className='col-span-12 xl:col-span-6'>
									...
									<div className='mt-3'>
										<label htmlFor='update-profile-form-12' className='form-label'>
											Bank Name
										</label>
										<TomSelect
									...
									<div className='mt-3'>
										<label htmlFor='update-profile-form-13' className='form-label'>
											Bank Account
										</label>
										<input
