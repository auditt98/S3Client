							...
							{$_.take($f(), 9).map((faker, fakerKey) => (
								<tr key={fakerKey} className='intro-x'>
									...
									<td>
										{faker.trueFalse[0] ? (
											<>
												<div className='whitespace-nowrap'>Direct bank transfer</div>
												<div className='text-slate-500 text-xs whitespace-nowrap mt-0.5'>
													25 March, 12:55
												</div>
											</>
											...
											<>
												<div className='whitespace-nowrap'>Checking payments</div>
												<div className='text-slate-500 text-xs whitespace-nowrap mt-0.5'>
													30 March, 11:00
												</div>
											</>
									...
									<td className='table-report__action'>
										<div className='flex justify-center items-center'>
											...
											>
												<Lucide icon='ArrowLeftRight' className='w-4 h-4 mr-1' />
												Change Status
											</a>
										</div>
									</td>
