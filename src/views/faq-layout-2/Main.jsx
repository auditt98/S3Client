					...
					<div className='box mt-5'>
						<div className='p-5'>
							<a className='flex items-center text-primary font-medium' href=''>
								<Lucide icon='Activity' className='w-4 h-4 mr-2' /> About Our Products
							</a>
							<a className='flex items-center mt-5' href=''>
								<Lucide icon='Box' className='w-4 h-4 mr-2' /> Related License
							</a>
							<a className='flex items-center mt-5' href=''>
								<Lucide icon='Lock' className='w-4 h-4 mr-2' /> Single Application License
							</a>
							<a className='flex items-center mt-5' href=''>
								<Lucide icon='Settings' className='w-4 h-4 mr-2' /> Multi Application License
							</a>
						</div>
						<div className='p-5 border-t border-slate-200/60 dark:border-darkmode-400'>
							...
							<a className='flex items-center mt-5' href=''>
								<Lucide icon='Settings' className='w-4 h-4 mr-2' /> Privacy Policy
							</a>
						</div>
						<div className='p-5 border-t border-slate-200/60 dark:border-darkmode-400'>
							<a className='flex items-center' href=''>
				...
				<div className='intro-y col-span-12 lg:col-span-8 xl:col-span-9'>
					<div className='intro-y box lg:mt-5'>
						<div className='flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
							<h2 className='font-medium text-base mr-auto'>About Our Products</h2>
						</div>
					...
					<div className='intro-y box mt-5'>
						<div className='flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
							<h2 className='font-medium text-base mr-auto'>Single Application License</h2>
						</div>
						<AccordionGroup className='p-5'>
							<AccordionItem>
								<Accordion>OpenSSL Essentials: Working with SSL Certificates, Private Keys</Accordion>
