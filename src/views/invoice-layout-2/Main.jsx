...
import { Lucide, Dropdown, DropdownToggle, DropdownMenu, DropdownContent } from '@/base-components';
			...
			<div className='intro-y box overflow-hidden mt-5'>
				...
				<div className='flex flex-col lg:flex-row border-b px-5 sm:px-20 pt-10 pb-10 sm:pb-20 text-center sm:text-left'>
					<div>
						...
						<div className='text-lg font-medium text-primary mt-2'>Arnold Schwarzenegger</div>
					...
					<div className='mt-10 lg:mt-0 lg:ml-auto lg:text-right'>
						...
						<div className='text-lg text-primary font-medium mt-2'>#1923195</div>
							...
							<tbody>
								<tr>
									<td className='border-b dark:border-darkmode-400'>
										<div className='font-medium whitespace-nowrap'>Midone HTML Admin Template</div>
										<div className='text-slate-500 text-sm mt-0.5 whitespace-nowrap'>
											Regular License
										</div>
									</td>
									<td className='text-right border-b dark:border-darkmode-400 w-32'>2</td>
									<td className='text-right border-b dark:border-darkmode-400 w-32'>$25</td>
								...
								<tr>
									<td className='border-b dark:border-darkmode-400'>
										<div className='font-medium whitespace-nowrap'>Vuejs Admin Template</div>
										<div className='text-slate-500 text-sm mt-0.5 whitespace-nowrap'>
											Regular License
										</div>
									</td>
									<td className='text-right border-b dark:border-darkmode-400 w-32'>1</td>
									<td className='text-right border-b dark:border-darkmode-400 w-32'>$25</td>
									<td className='text-right border-b dark:border-darkmode-400 w-32 font-medium'>
										$25
									</td>
								...
								<tr>
									<td className='border-b dark:border-darkmode-400'>
										<div className='font-medium whitespace-nowrap'>React Admin Template</div>
										<div className='text-slate-500 text-sm mt-0.5 whitespace-nowrap'>
											Regular License
										</div>
									</td>
								...
								<tr>
									<td>
										<div className='font-medium whitespace-nowrap'>Laravel Admin Template</div>
										<div className='text-slate-500 text-sm mt-0.5 whitespace-nowrap'>
											Regular License
										</div>
									</td>
				...
				<div className='px-5 sm:px-20 pb-10 sm:pb-20 flex flex-col-reverse sm:flex-row'>
					<div className='text-center sm:text-left mt-10 sm:mt-0'>
						...
						<div className='text-lg text-primary font-medium mt-2'>Elon Musk</div>
					...
					<div className='text-center sm:text-right sm:ml-auto'>
						...
						<div className='text-xl text-primary font-medium mt-2'>$20.600.00</div>
