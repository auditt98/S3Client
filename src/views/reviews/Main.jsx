		...
		<>
			...
			<div className='grid grid-cols-12 gap-6 mt-5'>
				<div className='intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2'>
					...
					<div className='hidden xl:block mx-auto text-slate-500'>Showing 1 to 10 of 150 entries</div>
							...
							{$_.take($f(), 9).map((faker, fakerKey) => (
								<tr key={fakerKey} className='intro-x'>
									...
									<td className='whitespace-nowrap'>
										<a className='flex items-center underline decoration-dotted' href='#'>
											{faker.users[0].name}
										</a>
									</td>
									...
									<td className='text-center whitespace-nowrap'>{faker.formattedTimes[0]}</td>
									<td className='w-40'>
										<div
									...
									<td className='table-report__action w-56'>
										<div className='flex justify-center items-center'>
											<a className='flex items-center text-primary whitespace-nowrap' href='#'>
												<Lucide icon='CheckSquare' className='w-4 h-4 mr-1' /> View Details
											</a>
										</div>
									</td>
								</tr>
