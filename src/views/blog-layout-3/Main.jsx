	...
	return (
		<>
			<div className='intro-y news xl:w-3/5 p-5 box mt-8'>
				{/* BEGIN: Blog Layout */}
				<h2 className='intro-y font-medium text-xl sm:text-2xl'>{$f()[0].news[0].title}</h2>
				...
				<div className='intro-y mt-6'>
					<div className='news__preview image-fit'>
						<img alt='Midone Tailwind HTML Admin Template' className='rounded-md' src={$f()[0].images[0]} />
					</div>
				</div>
					...
					<div className='pt-5'>
						<div className='flex'>
							...
							<div className='ml-3 flex-1'>
								...
								<div className='text-slate-500 text-xs sm:text-sm'>{$f()[0].formattedTimes[0]}</div>
					...
					<div className='mt-5 pt-5 border-t border-slate-200/60 dark:border-darkmode-400'>
						<div className='flex'>
							...
							<div className='ml-3 flex-1'>
								...
								<div className='text-slate-500 text-xs sm:text-sm'>{$f()[1].formattedTimes[0]}</div>
