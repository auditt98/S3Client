		...
		<>
			...
			<div className='intro-y grid grid-cols-11 gap-5 mt-5'>
				<div className='col-span-12 lg:col-span-4 2xl:col-span-3'>
					<div className='box p-5 rounded-md'>
						...
						<div className='flex items-center mt-3'>
							...
							Transaction Status:
							<span className='bg-success/20 text-success rounded px-2 ml-1'>Completed</span>
						</div>
					</div>
				...
				<div className='col-span-12 lg:col-span-7 2xl:col-span-8'>
					<div className='box p-5 rounded-md'>
						<div className='flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5'>
							<div className='font-medium text-base truncate'>Order Details</div>
							<a href='' className='flex items-center ml-auto text-primary'>
								...
								<tbody>
									{$_.take($f(), 8).map((faker, fakerKey) => (
										<tr key={fakerKey}>
											...
											<td className='text-right'>${faker.totals[0] + ',000.00'}</td>
											<td className='text-right'>2</td>
											<td className='text-right'>${faker.totals[0] * 2 + ',000.00'}</td>
										</tr>
									))}
								</tbody>
							</table>
