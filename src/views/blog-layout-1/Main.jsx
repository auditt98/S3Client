		...
		<>
			...
			<div className='intro-y grid grid-cols-12 gap-6 mt-5'>
				...
				{$_.take($f(), 9).map((faker, fakerKey) => (
					<div key={fakerKey} className='intro-y col-span-12 md:col-span-6 xl:col-span-4 box'>
						...
						<div className='p-5'>
							...
							<div className='text-slate-600 dark:text-slate-500 mt-2'>{faker.news[0].shortContent}</div>
						</div>
