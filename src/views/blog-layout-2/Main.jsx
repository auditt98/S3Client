		...
		<>
			<div className='intro-y flex flex-col sm:flex-row items-center mt-8'>
				...
				<div className='w-full sm:w-auto flex mt-4 sm:mt-0'>
					<button className='btn btn-primary shadow-md mr-2'>Add New Post</button>
					<Dropdown className='ml-auto sm:ml-0'>
						...
						<DropdownMenu className='w-40'>
							<DropdownContent>
								...
								<DropdownItem>
									<Lucide icon='Download' className='w-4 h-4 mr-2' /> Download Post
								</DropdownItem>
							</DropdownContent>
						</DropdownMenu>
					</Dropdown>
					...
					<div key={fakerKey} className='intro-y col-span-12 md:col-span-6 box'>
						<div className='h-[320px] before:block before:absolute before:w-full before:h-full before:top-0 before:left-0 before:z-10 before:bg-gradient-to-t before:from-black/90 before:to-black/10 image-fit'>
							...
							<div className='absolute w-full flex items-center px-5 pt-6 z-10'>
								...
								<div className='ml-3 text-white mr-auto'>
									...
									<div className='text-xs mt-0.5'>{faker.formattedTimes[0]}</div>
								</div>
								<Dropdown className='ml-3'>
									...
									>
										<Lucide icon='MoreVertical' className='w-4 h-4 text-white' />
									</DropdownToggle>
									<DropdownMenu className='w-40'>
										<DropdownContent>
											<DropdownItem>
							...
							<div className='absolute bottom-0 text-white px-5 pb-6 z-10'>
								<span className='bg-white/20 px-2 py-1 rounded'>{faker.products[0].category}</span>
								<a href='' className='block font-medium text-xl mt-3'>
									{faker.news[0].title}
								</a>
							</div>
						</div>
						<div className='p-5 text-slate-600 dark:text-slate-500'>{faker.news[0].shortContent}</div>
						...
						<div className='px-5 pt-3 pb-5 border-t border-slate-200/60 dark:border-darkmode-400'>
							<div className='w-full flex text-slate-500 text-xs sm:text-sm'>
								<div className='mr-2'>
									Comments: <span className='font-medium'>{faker.totals[0]}</span>
								</div>
								<div className='mr-2'>
							...
							<div className='w-full flex items-center mt-3'>
								...
								<div className='flex-1 relative text-slate-600 dark:text-slate-200'>
									...
									/>
									<Lucide icon='Smile' className='w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0' />
								</div>
							</div>
						</div>
					</div>
