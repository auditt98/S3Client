...
function Main() {
	...
	const [smallSlideOverSizePreview, setSmallSlideOverSizePreview] = useState(false);
	const [mediumSlideOverSizePreview, setMediumSlideOverSizePreview] = useState(false);
	...
	const [programmaticallySlideOver, setProgrammaticallySlideOver] = useState(false);
						...
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Blank Slide Over</h2>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Slide Over Size</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div id='slide-over-size' className='p-5'>
									<Preview>
										...
										>
											<ModalHeader className='p-5'>
												<h2 className='font-medium text-base mr-auto'>Small Slide Over</h2>
											</ModalHeader>
										...
										>
											<ModalHeader className='p-5'>
												<h2 className='font-medium text-base mr-auto'>Medium Slide Over</h2>
											</ModalHeader>
										...
										>
											<ModalHeader className='p-5'>
												<h2 className='font-medium text-base mr-auto'>Large Slide Over</h2>
											</ModalHeader>
										...
										>
											<ModalHeader className='p-5'>
												<h2 className='font-medium text-base mr-auto'>Superlarge Slide Over</h2>
											</ModalHeader>
											<ModalBody>This is totally awesome superlarge slide over!</ModalBody>
										</Modal>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Slide Over With Close Button</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div id='button-slide-over' className='p-5'>
									<Preview>
										...
										>
											...
											<ModalBody>This is totally awesome slide over with close button!</ModalBody>
										</Modal>
										{/* END: Modal Content */}
									</Preview>
									<Source>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Overlapping Slide Over</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Header & Footer Slide Over</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div id='header-footer-slide-over' className='p-5'>
									<Preview>
										...
										>
											...
											<ModalHeader className='p-5'>
												<h2 className='font-medium text-base mr-auto'>Broadcast Message</h2>
												<button className='btn btn-outline-secondary hidden sm:flex'>
													<Lucide icon='File' className='w-4 h-4 mr-2' /> Download Docs
												</button>
										...
										>
											...
											<ModalBody className='p-10 text-center'>
												...
												<a
													...
													onClick={() => {
														setProgrammaticallySlideOver(!programmaticallySlideOver);
													}}
												>
													Toggle Slide Over
												</a>
              ...
              `}
				...
				<div className='intro-y col-span-12 lg:col-span-6'>
					...
					<div className='intro-y box'>
						<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
							<h2 className='font-medium text-base mr-auto'>Component Reference</h2>
						</div>
						<div className='p-5'>
							<div>
							...
							<table className='table mt-5'>
								...
								<tbody>
									...
									<tr>
										...
										<td className='align-top'>`modal-sm`, `modal-lg`, `modal-xl`</td>
									...
									<tr>
										...
										<td className='align-top'>
											<div className='font-medium mb-1'>`String`</div>
											Whether the Modal backdrop is static or not. When backdrop is set to static,
									...
									<tr>
										...
										<td className='align-top'>-</td>
										<td className='align-top'>
											<div className='font-medium mb-1'>`Function`</div>A ref to the Modal
											element.
										</td>
									</tr>
								</tbody>
								...
								<tbody>
									<tr>
										...
										<td className='align-top'>
											...
											<span className='text-red-500'>show</span> instance method is called.
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td className='align-top'>
											...
											<span className='text-red-500'>hide</span> instance method has been called.
										</td>
									</tr>
									<tr>
