				...
				<div className='col-span-12 lg:col-span-4 2xl:col-span-3'>
					<div className='box p-5 rounded-md'>
						...
						<div className='flex items-center border-t border-slate-200/60 dark:border-darkmode-400 pt-5 mt-5 font-medium'>
							<button type='button' className='btn btn-outline-secondary w-full py-1 px-2'>
								Message User
							</button>
						</div>
					</div>
					<div className='box p-5 rounded-md mt-5'>
						...
						<div className='flex items-center mt-3'>
							<Lucide icon='Calendar' className='w-4 h-4 text-slate-500 mr-2' />
							Status:
							<span className='bg-success/20 text-success rounded px-2 ml-1'>Active</span>
						</div>
						<div className='flex items-center border-t border-slate-200/60 dark:border-darkmode-400 pt-5 mt-5 font-medium'>
							<button type='button' className='btn btn-outline-secondary w-full py-1 px-2'>
								Change Status
					...
					<div className='box p-5 rounded-md mt-5'>
						<div className='flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5'>
							<div className='font-medium text-base truncate'>Transaction Reports</div>
							<a href='' className='flex items-center ml-auto text-primary'>
								<Lucide icon='Edit' className='w-4 h-4 mr-2' /> More Details
							</a>
						</div>
						...
						<div className='flex items-center mt-3'>
							<Lucide icon='Star' className='w-4 h-4 text-slate-500 mr-2' /> Average Rating:
							<div className='ml-auto'>4.9+</div>
						</div>
						<div className='flex items-center mt-3'>
							<Lucide icon='Album' className='w-4 h-4 text-slate-500 mr-2' /> Total Products:
				...
				<div className='col-span-12 lg:col-span-7 2xl:col-span-8'>
					<div className='grid grid-cols-12 gap-5'>
						{$_.take($f(), 9).map((faker, fakerKey) => (
							<div key={fakerKey} className='intro-y col-span-12 sm:col-span-6 2xl:col-span-4'>
								<div className='box'>
									<div className='p-5'>
										...
										<div className='text-slate-600 dark:text-slate-500 mt-5'>
											...
											<div className='flex items-center mt-2'>
												<Lucide icon='Layers' className='w-4 h-4 mr-2' /> Remaining Stock:
												{faker.stocks[0]}
											</div>
											<div className='flex items-center mt-2'>
