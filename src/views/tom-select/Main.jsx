						...
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Basic Select</h2>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Multiple Select</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
								...
								<div className='p-5'>
									<Preview>
										<div className='flex'>
											...
											<TomSelect value={select} onChange={setSelect} className='w-full'>
												<option value='1'>Leonardo DiCaprio</option>
												<option value='2'>Johnny Deep</option>
												<option value='3'>Robert Downey, Jr</option>
												<option value='4'>Samuel L. Jackson</option>
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								...
								<div className='p-5'>
									<Preview>
										<TomSelect value={select} onChange={setSelect} className='w-full' disabled>
											<option value='1'>Leonardo DiCaprio</option>
											<option value='2'>Johnny Deep</option>
											<option value='3'>Robert Downey, Jr</option>
											<option value='4'>Samuel L. Jackson</option>
              ...
              `}
					...
					<PreviewComponent className='intro-y box mt-5'>
						{({ toggle }) => (
							<>
								<div className='flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400'>
									<h2 className='font-medium text-base mr-auto'>Disabled Option</h2>
									<div className='form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0'>
